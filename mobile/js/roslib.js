...
//    console.log(url);
    ...
    //console.log(url.indexOf("ngrok"));
    if(url.indexOf("robot")>=0 || url.indexOf("server")>=0)
    {
    //   console.log(url);
...
Topic.prototype.unsubscribe = function(callback) {
  ...
  if (!this.subscribeId) {console.log("failed."); return; }
  ...
  //console.log(this.subscribeId ,"success.")
